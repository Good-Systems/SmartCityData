...
### Prerequisites
The requirement.txt has all the python libraries for the program to work. It is important to update the requirements file after working on it for easy movement between lab mates and the upload to the server. Please use 'pip install requirements.txt' to install all required libraries.

Github Link:
https://github.com/Good-Systems/SmartCityData
